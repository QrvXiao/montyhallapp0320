...
import { createMontyHallRecord } from "../graphql/mutations";
const client = generateClient();
export default function MontyHallRecordCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setFirstChosenDoor(initialValues.firstChosenDoor);
    setRevealedDoor(initialValues.revealedDoor);
    setFinalChosenDoor(initialValues.finalChosenDoor);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMontyHallRecord.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MontyHallRecordCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
